 ...
 const trivia = [
     ...
     },
     {
         ...
         correctas: [
            "Medir la altura",
            "Timon",
            "Disminuye la presión encima del ala",
            "Ángulo de ataque",
            "Cabeceo"
        ],
         quizz : [
             {
                ...
                respuestas:[
                    "Medir la altura",
                    "Reducir la presion del aire en la altura",
                    "Reducir el arrastre"
                ]
             },
             {
             ...
             },
             {
                ...
                respuestas: [
                    "Disminuye la presión encima del ala",
                    "Ofrece más espacio para misiles",
                    "Controla el bandazo"
                ]
             },
             {
     ...
     },
     {
         ...
         correctas: [
            "Para hacer un aterrizaje instrumental",
            "Indica la velocidad apta para vuelos con FLAPS extendidos",
            "Frecuencia muy alta de rango omnidireccional",
            "Instrumento para ser localizado por el radar",
            "Señales de frecuencia de amplitud modulada" 
        ],
         quizz : [
             {
                id:1,
                ...
                respuestas:[
                    "Para hacer un aterrizaje instrumental",
                    "Para localizar el aeropuerto",
                    "Para cogerregir el giro direccional"
                ]
             },
             {
                id:2,
                pregunta:"¿Que indica el arco blanco en el velocimetro?",
                 respuestas:[
                    "Indica la velocidad apta para vuelos con FLAPS extendidos",
                    "Indica la velocidad de nunca exceder",
                    "Indica la velocidad de maniobra"
                ]
             },
             {
                id:3,
             ...
             },
             {
                ...
                respuestas:[
                    "Instrumento para ser localizado por el radar",
                    "Sistema de posicion global",
                    "Sistema para comunicacion radiofonica"
                ]
             },
             {
                id:5,
                ...
                respuestas:[
                    "Señales de frecuencia de amplitud modulada",
                    "Señales de radio de frecuencia modulada",
                    "Frecuencias del radar del aeropuerto"
                ]
             }
         ]
     }  
